...
public class HashUtils 
{
    ...
    /**
     * Converts a String into a salted hash array of bytes using the SHA-256 hashing algorithm. Salt is provided by a Zenith main config value.
    ...
    /**
     * Converts a String into a salted hash array of bytes using a supported hashing algorithm. Salt is provided by a Zenith main config value.
     * @param input Unhashed input
     * @return Salted hashed input
     */
    public static byte[] hashString(HashAlgorithm algorithm, String input)
    {
        try {
            ...
            digest.update((input + Zenith.getZenithConfig().get("hashSalt")).getBytes("UTF-8"));
