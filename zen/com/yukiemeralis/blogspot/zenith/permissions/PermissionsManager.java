...
/**
 * Base class for all Zenith permissions handlers.
...
public abstract class PermissionsManager 
{
    ...
    {
        if (!Zenith.getUuidCache().values().contains(uuid))
            return null;
        File accountFile = new File("./plugins/Zenith/playerdata/" + uuid + ".json");
