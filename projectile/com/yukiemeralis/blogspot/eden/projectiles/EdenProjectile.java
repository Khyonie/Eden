...
import com.yukiemeralis.blogspot.eden.utils.PacketUtils;

public class EdenProjectile
{
    private String uuid;
    ...
    public EdenProjectile(Class<? extends Projectile> projectileClass, ProjectileFlag... flags)
    {
        this.projectileClass = projectileClass;
        this.flags = Arrays.asList(flags);
    }

    public EdenProjectile(Class<? extends Projectile> projectileClass, long lifetime, ProjectileFlag... flags)
    {
    ...
    public void launch(ProjectileSource source)
    {
        ...
        if (this instanceof ParticleProjectile)
        {
            ...
            }.runTaskTimer(Eden.getInstance(), 2, 1);
        }
        ...
        if (lifetime != -1)
            ...
            }.runTaskLater(Eden.getInstance(), lifetime);
    }
