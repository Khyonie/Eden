...
public class PrintUtils 
{
    ...
    {
        if (zcolor_hex == null)
            zcolor_hex = Zenith.getModuleManager().getEnabledModuleByName("Zenith").getConfig().get("zColor");
        if (!zcolor_hex.equals(Zenith.getModuleManager().getEnabledModuleByName("Zenith").getConfig().get("zColor")))
            zcolor_hex = Zenith.getModuleManager().getEnabledModuleByName("Zenith").getConfig().get("zColor");
        return zcolor_hex;
    }
