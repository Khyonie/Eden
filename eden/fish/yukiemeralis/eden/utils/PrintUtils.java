...
public class PrintUtils 
{
    ...
    {
        sendComponent(target, buildComponents("&8[<#" + getEColorHex() + ">e&8] &7" + message, true, true));
    }
    ...
    private static String getEColorHex()
    {
        ...
        {
            ecolor_hex = switch (Eden.getModuleManager().getModuleByName("Rosetta").getConfig().getString("eColor")) {
                case Some s -> s.unwrap(String.class);
                case default -> "47FF9A";
            };
            return ecolor_hex;
        }
    ...
    /**
     * Outputs a singular when count == 1, otherwise outputs plural form.
     * @param count
     * @param singular
     * @param plural
