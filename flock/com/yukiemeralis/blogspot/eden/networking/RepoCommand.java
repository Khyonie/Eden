...
public class RepoCommand extends EdenCommand 
{
                                ...
                                switch (result.getState())
                                {
                                    ...
                                    case OK:
                                        if (sender instanceof Player)
                                            new RepositoryGui((Player) sender, entry.getHostRepo()).display((Player) sender);
    ...
    public void edencommand_open(CommandSender sender, String commandLabel, String[] args)
    {
        ...
        try {
            ...
            new RepositoryGui((Player) sender, repo, true).display((Player) sender);
        ...
        new RepositoryGui((Player) sender, NetworkingModule.getKnownRepositories().get(args[1])).display((Player) sender);
    }
