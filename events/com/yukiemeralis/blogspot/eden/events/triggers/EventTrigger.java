...
import com.yukiemeralis.blogspot.eden.events.gui.TriggerEditGui;
...
{
    private final List<EdenEvent> event;
    ...
    public EventTrigger(boolean synchronizeAttendees, int step, EdenEvent... events)
    {
    ...
    public List<EdenEvent> getAssociatedEvents()
    {
        return this.event;
    }
    ...
    public GuiItemStack toIcon()
    {
        ...
        for (EdenEvent events : this.event)
