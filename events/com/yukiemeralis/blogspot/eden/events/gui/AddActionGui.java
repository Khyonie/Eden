...
import com.yukiemeralis.blogspot.eden.events.core.ChatEventAction;
import com.yukiemeralis.blogspot.eden.events.core.EditBlockEventAction;
import com.yukiemeralis.blogspot.eden.events.core.EntitySpawnEventAction;
import com.yukiemeralis.blogspot.eden.events.core.TeleportEventAction;
...
public class AddActionGui extends PagedDynamicGui
{
    ...
    {
        private final Class<? extends EdenEvent> action;
        ...
        public ActionAdapter(Class<? extends EdenEvent> action, EventTrigger<?> trigger, Object... defaultValues)
        {
        ...
        public GuiItemStack toIcon()
        {
            GuiItemStack item = new GuiItemStack(Material.PAPER)
            {
                ...
                public void onIconInteract(InventoryClickEvent event)
                {
                    ...
                    EdenEvent actionFinal;
                    try {
                        Constructor<?> constructor = action.getConstructor(params);
                        actionFinal = (EdenEvent) constructor.newInstance(defaultValues);
