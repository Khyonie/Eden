...
import com.yukiemeralis.blogspot.eden.events.WrappedType;
import com.yukiemeralis.blogspot.eden.events.EdenEvent;
import com.yukiemeralis.blogspot.eden.events.triggers.BlockInteractTrigger;
import com.yukiemeralis.blogspot.eden.events.triggers.EventTrigger;
import com.yukiemeralis.blogspot.eden.events.triggers.PlayerReachLocationTrigger;
import com.yukiemeralis.blogspot.eden.events.triggers.TimeTrigger;
import com.yukiemeralis.blogspot.eden.events.triggers.TrueTrigger;
...
public class AddTriggerGui extends PagedDynamicGui
{
    ...
    private static List<GuiComponent> genTriggerList(EventScript script)
    {
        ...
        triggers.add(new TriggerAdapter(script, PlayerReachLocationTrigger.class, false, -1, (Location) new Location(null, 0, 0, 0), 0.0d, new EdenEvent[0])); // boolean, int, Location, double, EdenEvent...
        triggers.add(new TriggerAdapter(script, TimeTrigger.class, false, -1, new ArrayList<Entity>(), 0l, new EdenEvent[0])); // boolean, int, List<Entity>, long, EdenEvent...
        triggers.add(new TriggerAdapter(script, BlockInteractTrigger.class, false, -1, new WrappedType<Block>(Block.class, null), new EdenEvent[0]));
        triggers.add(new TriggerAdapter(script, TrueTrigger.class, false, -1, new ArrayList<Entity>(), new EdenEvent[0]));
